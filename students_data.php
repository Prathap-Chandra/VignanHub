...
<nav class="navbar navbar-inverse navbar-fixed-top" style="height:5px;">
  ...
  <table class="table table-condensed table-striped table-bordered table-hover tabledesign" style="cellpadding:10;">
    <caption>
      <center><h3>Student Results</h3></center>
    </caption >
    <thead style="background-color:#ffffff;">
      ...
      <tr>
        ...
        <th scope="col"><center>Dept</center></th>
        <th scope="col"><center>Batch</center></th>
        <th scope="col"><center>Skills</center></th>
        <th scope="col"><center>Internship Experience</center></th>
      </tr>
    </thead>
  ...
  while($row=mysqli_fetch_array($query)){
    echo '
    <tr>
      <td scope="col"><center>'.$row['username'].'</center></td>
      <td scope="col"><center>'.$row['rollno'].'</center></td>
      <td scope="col"><center>'.$row['dept'].'</center></td>
      <td scope="col"><center>'.$row['batch'].'</center></td>
      <td scope="col"><center>'.$row['skills'].'</center></td>
      <td scope="col"><center>'.$row['interns'].'</center></td>
    </tr>';
  }
  ?>
    </tbody>
