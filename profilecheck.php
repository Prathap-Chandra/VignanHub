    ...
    <div class="box box-info">
            ...
            <div class="box-body">
                     ...
                     <div  align="center">   <?php
                        $res=mysqli_query($conn,"select * from faculty_signup where username='$term'");
                        while($row=mysqli_fetch_array($res))
                        {
...
<div class="col-sm-5 col-xs-6 tital " >Date Of Joining:</div><div class="col-sm-7">
  <?php
   $query=mysqli_query($conn,"select * from faculty_signup where username='$term'");
   if($query){
     while($row=mysqli_fetch_array($query)){
...
<div class="col-sm-5 col-xs-6 tital " >Experience:</div><div class="col-sm-7">
  <?php
   $query=mysqli_query($conn,"select * from faculty_signup where username='$term'");
   if($query){
     while($row=mysqli_fetch_array($query)){
...
<div class="col-sm-5 col-xs-6 tital " >Research Area:</div><div class="col-sm-7">
  <?php
   $query=mysqli_query($conn,"select * from faculty_signup where username='$term'");
   if($query){
     while($row=mysqli_fetch_array($query)){
...
<div class="col-sm-5 col-xs-6 tital " >No.of Journls Published:</div><div class="col-sm-7">
  <?php
   $query=mysqli_query($conn,"select * from faculty_signup where username='$term'");
   if($query){
     while($row=mysqli_fetch_array($query)){
