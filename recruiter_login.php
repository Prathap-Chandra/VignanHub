...
$check_user="select * from recruiter_signup where username='$rec_username' and password='$password'";
$run=mysqli_query($conn,$check_user);
if(mysqli_num_rows($run)>0)
{
    $_SESSION['rec_username']=$rec_username;
    echo "<script>window.open('rec_homepage.php','_self')</script>";
...
<div class="container"><br><br><br><br><br>
  <div class="jumbotron">
    ...
    <center>
      <a href="recruiter_signup.php" style="text-decoration:none; color:#ffffff;">Signup for VignanHub</a><br><br>
