...
if(isset($_POST['submit']))
{
  ...
  $image= addslashes(file_get_contents($_FILES['image']['tmp_name']));
    $query=mysqli_query($conn,"insert into userposts(username,content,created_on,privacy,image) values('$std_username','$content',NOW(),'$privacy','$image')");
    if($query){
    echo '<br><br><br><br>
    <center>
    ...
    $query=mysqli_query($conn,"insert into userposts(username,content,created_on,privacy) values('$std_username','$content',NOW(),'$privacy')");
    if($query)
    echo '<br><br><br><br>
    <center>
    <div class="alert alert-danger alert-dismissible" style="background-color: #3b5998; color:#ffffff; width:60%;">
