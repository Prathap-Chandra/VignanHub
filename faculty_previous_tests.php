...
<?php
$query=mysqli_query($conn,"select * from questions where faculty='$faculty_username' ");
while($row=mysqli_fetch_array($query)){
  echo '
  <tr>
    <th scope="col"><center>'.$row['topic'].'</center></th>
    <th scope="col"><center>'.$row['times'].'</center></th>
  </tr>';
}
?>
...
<table class="table table-condensed table-striped table-bordered table-hover tabledesign" style="cellpadding:10">
  ...
  <thead style="background-color:#ffffff;">
    <tr><th colspan="10"><center><b>Tests That Were Conducted By Others On Respective Dates</b></center></th></tr>
    <tr>
      <th scope="col"><center>Fculty</center></th>
      <th scope="col"><center>Topic Names</center></th>
      <th scope="col"><center>Date</center></th>
    </tr>
  </thead>
