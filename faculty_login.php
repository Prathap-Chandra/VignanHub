...
$check_user="select * from faculty_signup where username='$username' and password='$password'";
$run=mysqli_query($conn,$check_user);
if(mysqli_num_rows($run)>0)
{
    $_SESSION['faculty_username']=$username;
    echo "<script>window.open('faculty_homepage.php','_self')</script>";
...
<div class="container">
  ...
  <div class="jumbotron">
    ...
    <center>
      <a href="faculty_signup.php" style="text-decoration:none; color:#ffffff;">Signup for VignanHub</a><br><br>
