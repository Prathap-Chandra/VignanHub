      ...
      <div class="collapse navbar-collapse" id="myNavbar">
        <ul class="nav navbar-nav">
          ...
          <li><a href="rec_profile.php" style="padding-top:10px;">
            <?php
             // $query=mysqli_query($conn,"select * from rec_signup where username='$rec_username'");
...
<div class="row" >
  <div class="col-md-8" >
<?php
$query=mysqli_query($conn,"select * from userposts where username='$rec_username' order by created_on desc");
